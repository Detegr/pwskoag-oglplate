...
C_StaticEntity::C_StaticEntity(b2World& w, C_Entity* e, float32 s)
{
	...
	float entityscale=this->m_Entity->M_Scale();
	// Orig model: 2.0f, 0.1f -> 1.0f, 0.05f
	hitshape.SetAsBox(1.0f*entityscale*s, 0.05f*entityscale*s, b2Vec2(0.0f, -0.05f*entityscale*s), 0);
...
C_DynamicEntity::C_DynamicEntity(b2World& w, C_Entity* e, float32 s)
{
	...
	b2PolygonShape hitshape;
	// Orig model: 2.0f, 1.5f -> 1.0f, 0.75f
	hitshape.SetAsBox(1.0f*entityscale*s, 0.75f*entityscale*s, b2Vec2(0.0f, 0.175f*entityscale*s), 0);
